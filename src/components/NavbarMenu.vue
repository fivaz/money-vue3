<template>
	<Menu as="div" class="relative inline-block text-left">
		<div>
			...
			>
				<MenuItems
					class="absolute right-0 mt-2 w-24 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none dark:bg-slate-800"
				>
					<div class="px-1 py-1">
