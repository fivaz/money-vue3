<template>
	<Listbox :by="by" as="div" v-model="model">
		...
		<div class="relative">
			<ListboxButton
				class="relative block w-full cursor-default rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-left shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600 focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm sm:leading-6 dark:bg-white/5 dark:ring-white/10 dark:focus:ring-indigo-500"
			>
			...
			>
				<ListboxOptions
					class="absolute z-10 mt-1 block max-h-60 w-full overflow-auto rounded-md border-0 bg-white py-1.5 text-base shadow-sm ring-1 ring-inset ring-black/5 ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-[#293445] dark:ring-white/10 dark:focus:ring-indigo-500"
				>
					<slot></slot>
				</ListboxOptions>
			</transition>
