		...
		<div class="relative">
			...
			>
				<ListboxOptions
					:class="[
						MAIN_COLOR_BG,
						'absolute z-10 mt-1 block max-h-60 w-full overflow-auto rounded-md border-0 bg-red-500 py-1.5 text-base shadow-sm ring-1 ring-inset ring-black/5 ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6 dark:ring-white/10',
					]"
				>
					<slot />
				</ListboxOptions>
